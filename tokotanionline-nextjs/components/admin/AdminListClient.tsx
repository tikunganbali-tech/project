 ...
 * 
 * Component: AdminListClient
 * 
 * Fungsi: Menampilkan daftar admin dengan conditional actions
 * 
 * Prinsip:
...
export default function AdminListClient() {
  ...
  // ✅ PERMISSION CHECKS (UI hanya menyembunyikan, bukan mengizinkan)
  const canView = hasPermission(userRole, 'system.view');
  const canWrite = hasPermission(userRole, 'system.manage');
  const canCreate = canWrite; // Create requires system.manage
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {/* ✅ CONDITIONAL RENDERING: Create button hanya muncul jika canWrite */}
        {canCreate && (
          <button
